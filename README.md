...
Client side routing downloads the entire application and has the browser handle all routing. In serverside routing, the server handles this and the browser only downloads the current page.
